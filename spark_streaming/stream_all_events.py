...
listen_events_writer = create_file_write_stream(listen_events,
                                                ...
                                                "{}/{}".format(GCS_STORAGE_PATH, LISTEN_EVENTS_TOPIC),
                                                "{}/checkpoint/{}".format(GCS_STORAGE_PATH, LISTEN_EVENTS_TOPIC)
                                                )
...
page_view_events_writer = create_file_write_stream(page_view_events,
                                                ...
                                                "{}/{}".format(GCS_STORAGE_PATH, PAGE_VIEW_EVENTS_TOPIC),
                                                "{}/checkpoint/{}".format(GCS_STORAGE_PATH, PAGE_VIEW_EVENTS_TOPIC)
                                                   )
...
auth_events_writer = create_file_write_stream(auth_events,
                                            ...
                                            "{}/{}".format(GCS_STORAGE_PATH, AUTH_EVENTS_TOPIC),
                                            "{}/checkpoint/{}".format(GCS_STORAGE_PATH, AUTH_EVENTS_TOPIC)
                                              )
